...
//  TravelBook
//
//  Created by Faruk Eymen Baltaci on 11.11.2022.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func saveButtonClicked(_ sender: Any) {
        ...
        if nameText.text == "" && commentText.text == "" {
            ...
            makeAlert(titleInput: "Error!", messageInput: "Please fill in name")
        }
        else if commentText.text == "" {
            makeAlert(titleInput: "Error!", messageInput: "Please fill in comment")
        }
            ...
            makeAlert(titleInput: "Success", messageInput: "Location successfully saved")
        }
